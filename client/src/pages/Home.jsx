      ...
      <div className="text-start hero-content">
        <div className="max-w-md">
          ...
          <p className="py-6">
            ...
            internet. You can visit create new clients, which will be rendered
            in a table. As it is currently a simple application, it does not
            have a proper authentication system set up. Enjoy!
          </p>
